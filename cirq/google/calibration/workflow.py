...
def prepare_floquet_characterization_for_operations(
    ...
    The major advantage of this method is that the number of characterization requests is bounded by
    four for grid-like devices, where for the prepare_floquet_characterization_for_moments the
    number of characterizations is bounded by number of moments in a circuit.
